        ...
        <div className="project-content">
          ...
          <div className="project-achievements" style={{ marginBottom: '2.5rem' }}>
            ...
            <ul style={{ 
              ...
              <li style={{ marginBottom: '0.75rem' }}>Developed the full website, showcasing a variety of fitness and activewear products, including sports bras, tops, bottoms, accessories, and reusable masks, all integrated with a seamless e-commerce shopping experience.</li>
              <li style={{ marginBottom: '0.75rem' }}>Set up product categories and filtering options, enabling users to easily browse through new arrivals, sport bras, tops, bottoms, and accessories.</li>
              <li style={{ marginBottom: '0.75rem' }}>Implemented a merchandise store featuring activewear with detailed product information, pricing, and "Add to Cart" functionality, improving the overall user experience.</li>
              <li style={{ marginBottom: '0.75rem' }}>Designed an informative blog section covering topics related to fitness, sustainability, and breast cancer screening, providing additional value to the website visitors.</li>
              <li style={{ marginBottom: '0.75rem' }}>Built a specialized section to display and facilitate transactions for the "Hoya Kerry Girls" NFT collection, integrating with OpenSea for easy interaction with the Ethereum blockchain.</li>
            </ul>
          </div>
