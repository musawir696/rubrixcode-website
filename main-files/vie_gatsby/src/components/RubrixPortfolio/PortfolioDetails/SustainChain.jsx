        ...
        <div className="project-content">
          ...
          <div className="project-achievements" style={{ marginBottom: '2.5rem' }}>
            ...
            <ul style={{ 
              ...
              <li style={{ marginBottom: '0.75rem' }}>Developed a comprehensive and secure website to support the minting and management of STC tokens.</li>
              <li style={{ marginBottom: '0.75rem' }}>Integrated various features such as real-time token market updates, secure wallet connections, and a robust user interface.</li>
              <li style={{ marginBottom: '0.75rem' }}>Enabled seamless access to membership plans, exclusive NFTs, and support for eco-friendly construction projects.</li>
              <li style={{ marginBottom: '0.75rem' }}>Focused on delivering a transparent and user-friendly platform to enhance community engagement and trust.</li>
            </ul>
          </div>
