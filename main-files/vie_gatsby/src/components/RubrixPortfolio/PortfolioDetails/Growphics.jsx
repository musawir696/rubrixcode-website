        ...
        <div className="project-content">
          ...
          <div className="project-achievements" style={{ marginBottom: '2.5rem' }}>
            ...
            <ul style={{ 
              ...
              <li style={{ marginBottom: '0.75rem' }}>Enhanced Artistic Styling: Redesigned the site with a more visually appealing and artistic layout, including 2x larger sliders and catalog images.</li>
              <li style={{ marginBottom: '0.75rem' }}>Improved User Interface: Styled components and catalog cards for a more user-friendly and engaging experience, with sticky WhatsApp chat signs added.</li>
              <li style={{ marginBottom: '0.75rem' }}>Responsive Design: Ensured the site is fully responsive, providing a seamless experience on all devices.</li>
              <li style={{ marginBottom: '0.75rem' }}>HCI and Aesthetic Enhancements: Applied Human-Computer Interaction principles and the 60/20/20 rule for a balanced and cohesive design.</li>
              <li style={{ marginBottom: '0.75rem' }}>Performance Optimization: Utilized React Suspense methodologies and ANT Design components to optimize performance and improve navigation with breadcrumbs.</li>
            </ul>
          </div>
