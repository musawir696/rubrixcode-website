        ...
        <div className="project-content">
          ...
          <div className="project-achievements" style={{ marginBottom: '2.5rem' }}>
            ...
            <ul style={{ 
              ...
              <li style={{ marginBottom: '0.75rem' }}>Designed an intuitive, accessible interface in Figma with seamless navigation for relocation services.</li>
              <li style={{ marginBottom: '0.75rem' }}>Developed a React-based portal with real-time tracking and dashboards for employee transfers and employer oversight.</li>
              <li style={{ marginBottom: '0.75rem' }}>Integrated relocation tools like housing search, visa tracking, and budget management, with multi-language support using React-i18next.</li>
              <li style={{ marginBottom: '0.75rem' }}>Optimized performance through rigorous testing and enhanced SEO for visibility in Nordic markets.</li>
              <li style={{ marginBottom: '0.75rem' }}>Collaborated with stakeholders to deliver a polished, user-friendly platform aligned with Sweden Relocators' mission.</li>
            </ul>
          </div>
