      ...
      <div className="container">
        ...
        <div className="project-content">
          ...
          <p style={{ 
            ...
            Lumino is a digital agency specializing in creative and tech‑savvy solutions to help businesses stand out. The site showcases impactful and visually stunning brand experiences.
          </p>
          ...
          <div className="project-achievements" style={{ marginBottom: '2.5rem' }}>
            ...
            <ul style={{ 
              ...
              <li style={{ marginBottom: '0.75rem' }}>Designed and developed the entire website using React with cohesive look and feel.</li>
              <li style={{ marginBottom: '0.75rem' }}>Created detailed About, Services (design agency and digital marketing), and team sections.</li>
              <li style={{ marginBottom: '0.75rem' }}>Integrated portfolios within services and added videos, animations, and dynamic content.</li>
              <li style={{ marginBottom: '0.75rem' }}>Built pricing and contact pages; ensured full responsiveness across devices.</li>
            </ul>
          </div>
          ...
          <div className="project-links" style={{ marginBottom: '2.5rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <a 
                href="https://luminostudios.netlify.app/" 
                target="_blank"
          ...
          <div className="tech-stack" style={{ marginBottom: '2.5rem' }}>
            ...
            <div style={{ 
              ...
              {['React', 'JavaScript', 'HTML', 'CSS', 'Node.js', 'Figma', 'Canva', 'Firebase', 'MongoDB', 'Google API'].map(tech => (
                <span
                  key={tech}
                  style={{
