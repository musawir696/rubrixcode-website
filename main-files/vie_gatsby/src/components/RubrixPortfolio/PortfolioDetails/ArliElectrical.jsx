        ...
        <div className="project-content">
          ...
          <div className="project-achievements" style={{ marginBottom: '2.5rem' }}>
            ...
            <ul style={{ 
              ...
              <li style={{ marginBottom: '0.75rem' }}>Designed and developed a clear, visually appealing website to present Arli Electrical's wide range of services, including installations, maintenance, and emergency responses.</li>
              <li style={{ marginBottom: '0.75rem' }}>Implemented intuitive navigation for customers to easily find service information, request quotes, and make contact for urgent needs.</li>
              <li style={{ marginBottom: '0.75rem' }}>Ensured mobile responsiveness, optimizing the website for a smooth experience across devices.</li>
              <li style={{ marginBottom: '0.75rem' }}>Enhanced customer engagement by offering multiple contact options, including phone and online forms, facilitating quick communication.</li>
            </ul>
          </div>
